...
use Deicer\Query\Event\TokenizedQueryEventInterface;
use Deicer\Exception\Type\NonStringException;

/**
 * A representation of an event generated by an tokenized query
 *
 ...
 */
class TokenizedQueryEvent extends AbstractQueryEvent implements
    TokenizedQueryEventInterface
{
    /**
     * Unique token
     * 
