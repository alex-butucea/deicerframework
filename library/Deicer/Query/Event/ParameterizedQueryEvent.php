...
use Deicer\Query\Event\ParameterizedQueryEventInterface;
use Deicer\Exception\Type\NonStringException;

/**
 * A representation of an event generated by an parameterized query
 *
 ...
 */
class ParameterizedQueryEvent extends AbstractQueryEvent implements
    ParameterizedQueryEventInterface
{
    /**
