...
/**
 * Abstract Colt Model Composite unit test suite
 * 
 * @category   ColtTest
 * @package    Model
 * @version    $id$
...
class AbstractModelCompositeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $first  = $this->getMock('Colt\Model\ModelInterface');
        $second = $this->getMock('Colt\Model\ModelInterface');
        $third  = $this->getMock('Colt\Model\ModelInterface');
    ...
    public function testExchangeArrayWithMixedIndexArrayInternalisesModelsReindexed()
    {
        ...
        $this->assertInstanceOf('Colt\Model\ModelInterface', $fixture->offsetGet(0));
        $this->assertInstanceOf('Colt\Model\ModelInterface', $fixture->offsetGet(1));
        $this->assertInstanceOf('Colt\Model\ModelInterface', $fixture->offsetGet(2));
    ...
    {
        $this->setExpectedException('Colt\Exception\Type\NonInstanceException');
        $fixture = new TestableModelComposite();
    ...
    {
        $fixture = new TestableModelComposite($this->validExchangeArrayArg);
        $this->assertInstanceOf('Colt\Model\ModelInterface', $fixture->current());
